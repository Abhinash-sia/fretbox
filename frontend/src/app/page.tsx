...
// Static Demonstration Data (F1 Shell Showcase)
const DEMO_METRICS = [
...
export default function F1ShellValidationPage() {
  ...
  return (
    <AppShell initialRole="student">
      ...
      <div className="mb-6 flex items-center justify-between rounded-lg border border-emerald-200 bg-emerald-50/60 p-3.5 dark:border-emerald-900/50 dark:bg-emerald-950/30">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-emerald-900 dark:text-emerald-200">
              Phase F1 Demonstration Shell & Design System
            </p>
            <p className="text-[11px] text-emerald-700 dark:text-emerald-400">
              Use the sidebar role switcher to inspect role-aware navigation trees. All data below is static demonstration content.
            </p>
          </div>
        </div>
      ...
      {/* 4. Showcase Tabs (Interactive Components vs UI State Skeletons) */}
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Input placeholder="Filter by student or room..." className="h-8 w-48 text-xs" />
              </div>
            </CardHeader>
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {DEMO_OPERATIONAL_TABLE.map((row) => (
                    <TableRow key={row.id}>
        ...
        <TabsContent value="empty" className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <ErrorState
              ...
              message="Redis cache cluster is offline. Systems are operating under MongoDB fallback mode."
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Fretbox modal dialog primitive configured with backdrop blur, focus trapping, and accessible controls.
            </DialogDescription>
          </DialogHeader>
