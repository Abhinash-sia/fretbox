...
export default function FacultyNotificationsPage() {
  ...
  return (
    <ProtectedRoute allowedRoles={['faculty']}>
      <AppShell>
        <PageHeader
          heading="Faculty Notifications & Campus Notices"
          subheading="Personal operational alerts, teaching notifications, and institutional announcements."
        />
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-bold flex items-center gap-2">
                  ...
                  <span>Faculty Operational Alerts</span>
                </CardTitle>
                <CardDescription className="text-xs">
                  Academic notifications and automated system updates.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 text-xs">
                {notifLoading ? (
                  ...
                  <EmptyState title="No Personal Notifications" description="You have no personal notifications or alerts at this time." />
                )}
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="announcements">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-xs">
                  Official notices broadcast by campus administration and wardens.
                </CardDescription>
              </CardHeader>
